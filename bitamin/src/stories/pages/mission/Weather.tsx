...
// 이미지 파일을 import합니다.
import sunnyImg from 'assets/missionImage/sunny.png'
import blueCloudImg from 'assets/missionImage/blue_cloud.png'
import darkCloudImg from 'assets/missionImage/dark_cloud.png'
import rainyImg from 'assets/missionImage/rainy.png'
import snowImg from 'assets/missionImage/snow.png'
  ...
  useEffect(() => {
    ...
    const getClosestTime = () => {
      ...
      return times.reduce((prev, curr) =>
        Math.abs(Number(curr) - now) < Math.abs(Number(prev) - now)
          ? curr
          : prev
      )
    }
    ...
    axios
      .get(API_URL, {
        params: {
          ServiceKey:
            'aQ/KD9B2XVnmNv0SkIefiz7rV6Ccy78ElnPFBkXZLRQ7jBbpWfCIBnp16ZEHqHC24e/AiNSPdfFIl66DEGReng==',
          dataType: 'JSON',
          base_date: todayStr,
