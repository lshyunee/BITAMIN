...
const App: React.FC = () => {
  ...
  const [hasCompletedTodayMission, setHasCompletedTodayMission] =
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.missionSection}>
          <div className={styles.missionContainer}>
            {!hasCompletedTodayMission &&
              selectedDate?.toISOString().split('T')[0] === todayDate && (
                <Missionform
                  onMissionComplete={() => setHasCompletedTodayMission(true)}
                />
              )}
